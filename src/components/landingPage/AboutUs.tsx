            ...
            <div className="container-xxl py-5" id="yatri-about">
                <div className="container">
                    <div className="row g-5">
                        <div className="col-lg-6 wow fadeInUp d-flex align-items-center justify-content-center" data-wow-delay="0.1s">
                            {/* <div className="position-relative h-100 "> */}
                            <div className="ty-ring">

                                <img className="traveller-img  img-fluid" src="img/about.jpg" alt="" style={{ objectFit: "cover" }} />
                            </div>
                            {/* </div> */}
                        </div>
                        <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            <h6 className="section-title bg-white text-start text-primary pe-3">About Us</h6>
                            <h1 className="mb-4">Welcome to <span className="text-primary">Travel Yatri</span></h1>
                            <p className="mb-4">At travelYatri, we believe that every journey should be an adventure, whether you’re exploring a new city or revisiting a favorite destination. Our platform connects passionate travelers with experienced trip organizers, making it easier than ever to find, plan, and embark on the perfect getaway.</p>
