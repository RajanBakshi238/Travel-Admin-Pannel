                ...
                <div className="container">
                    <div className="row g-5">
                        ...
                        <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <p className="mb-4">We are a travel company specializing in group travel packages and also operate a platform that connects travel agencies/organizers with travelers.</p>
