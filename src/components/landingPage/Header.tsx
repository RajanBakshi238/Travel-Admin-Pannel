            ...
            <div className="container-fluid position-relative p-0" id="yatri-home">
                <nav className={`navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0 ${isSticky ? 'sticky-top shadow-sm' : ''}`}>
                    <a href="" className="navbar-brand p-0 home-site-logo" >
                        ...
                        <img src="/img/logo/travel-yatri-logo-2.svg" alt="sit_logo"/>
                    </a>
                    ...
                    <div className="container py-5">
                        <div className="row justify-content-center py-5">
                            <div className="col-lg-10 pt-lg-5 mt-lg-5 text-center position-relative">
                                <h1 className="display-3 text-white mb-3 animated slideInDown">The World is Waiting for You</h1>
                                <p className="fs-4 text-white mb-4 animated slideInDown">From hidden gems to iconic landmarks, start your journey with us today.</p>
