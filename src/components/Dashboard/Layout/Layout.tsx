    ...
    return <div className="dashboard-ty layout-ty"><div className="main-wrapper">
        ...
        <Navbar className="main-header" expand="lg" >
            <Container fluid>
                ...
                <div className="responsive-bar" onClick={() => setShow((prev) => !prev)}>
        ...
        <Offcanvas show={show} onHide={handleClose} placement="end" >
            <Offcanvas.Header closeButton>
                <Offcanvas.Title>Travel yatri</Offcanvas.Title>
            </Offcanvas.Header>
            <Offcanvas.Body>
                    ...
                    {user?.role === ORGANIZER ? <>
                        {user?.isVerified ? <>
                            ...
                            <Link to="/dashboard/all-trip">
                                <div className="mt-4 canvas-item">
                                    <div><i className="fas fa-plane-departure"></i></div>
                        ...
                        user?.role === ADMIN ? <>
                            ...
                            <Link to="/dashboard/admin-organizer">
                                <div className="canvas-item">
                                    <div><i className="fas fa-user-lock"></i></div>
